...
<div class="page-header d-flex justify-content-between align-items-center">
    <h2><i class="bi bi-journal-plus"></i> Input Jurnal Umum</h2>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil-square"></i> Form Jurnal Double-Entry
            </div>
            <div class="card-body">
                ...
                <div class="alert alert-success d-flex gap-2 py-2 mb-3" style="font-size:0.85rem;">
                    ...
                    Jurnal ini akan otomatis memperbarui saldo rekening terkait.
                </div>
                    ...
                    <div class="row g-3">
                            ...
                            <select name="rekening_debet"
                                ...
                                @foreach($akunList as $akun)
                                    <option value="{{ $akun->kode_akun }}"
                                        {{ old('rekening_debet') === $akun->kode_akun ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="rekening_kredit"
                                ...
                                @foreach($akunList as $akun)
                                    <option value="{{ $akun->kode_akun }}"
                                        {{ old('rekening_kredit') === $akun->kode_akun ? 'selected' : '' }}>
                                        {{ $akun->kode_akun }} — {{ $akun->nama_akun }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('keterangan_transaksi') }}"
